...
const {updateBusinessUser,getBusinessDetails,getCategoryBusinessList,getAllBusinessList,BusinessViwersCount} = require('../controllers/business-controller')
...
router.post('/businessViwersCount',BusinessViwersCount)
